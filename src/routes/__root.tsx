...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Space — Practice & Compete" },
      {
        name: "description",
        content:
          "Practice and competition platform for coding students preparing for technical interviews and programming contests.",
      },
      { name: "author", content: "Space" },
      { property: "og:title", content: "Space — Practice & Compete" },
      {
